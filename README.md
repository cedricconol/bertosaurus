...
1. create an environment `bertosaurus` with the help of [conda],
   ```
...
├── src
│   └── bertosaurus         <- Actual Python package where the main functionality goes.
